 ...
 *   cd job-demo-parent
 *   mvn clean install
 *   mvn test -f job-core/pom.xml -Dtest=com.github.krakenninja.demo.confluent.configuration.ConfluentCloudConfigurationIntegrationTest
 * </pre>
 * </p>
 * @since 1.0.0
...
public class ConfluentCloudConfigurationIntegrationTest
{
    @Autowired
